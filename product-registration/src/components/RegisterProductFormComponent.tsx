...
const RegisterProductFormComponent = () => {
  ...
  const productSchema = yup.object({
    ...
    price: yup
      .number()
      .typeError("Insira o preço do produto")
  ...
  return (
    <div className="flex w-screen justify-center items-center mt-32">
      <form
        className="border-solid border border-#D2D2D2 mb-20 rounded-lg w-11/12 max-w-2xl h-auto flex flex-col p-6"
      ...
      >
        ...
        <button
          type="submit"
          className="mt-10 h-10 w-11/12 max-w-xs bg-primary hover:bg-hover rounded-md text-white self-center"
        >
          Cadastrar
        </button>
      </form>
